...
```{r}
library(readr)
ddf_datapoints_population_total_by_global_time <- read_csv("data/global-regions-datapoints/ddf--datapoints--population_total--by--global--time.csv")
View(ddf_datapoints_population_total_by_global_time)
```
